...
# filename <- "Plots/Culex/culex_temporal_variability_2.jpg"
# ggsave(filename, dpi = 300, width = 15, height = 6, units = "in", type = "jpg", quality = 100)
...
culex_UTM1x1$predicted_value_culex <-
  (culex_UTM1x1$mean_counts - min(culex_UTM1x1$mean_counts)) /
